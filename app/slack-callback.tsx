...
export default function SlackCallbackScreen() {
  ...
  useEffect(() => {
    ...
    slackService.exchangeCode(code)
      .then(({ teamName, workspaceCount }) => {
        setLabel(`「${teamName}」と連携しました（${workspaceCount}/5）`);
        setState('success');
        ...
        {state === 'loading' && (
          <>
            <View style={styles.iconRing}>
              <Ionicons name="chatbubbles-outline" size={28} color={Colors.brand.primary} />
            </View>
            <Text style={styles.cardTitle}>Slackと連携中...</Text>
