...
const styles = StyleSheet.create({
  ...
  createBannerTitle: { fontSize: 17, fontWeight: '700', color: Colors.text.dark },
  createBannerSub:   { fontSize: 12, color: Colors.text.darkSecondary, lineHeight: 18 },
  createBannerBtn:   {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  showTitle: { fontSize: 14, fontWeight: '700', color: Colors.text.dark, lineHeight: 20 },
  showDesc:  { fontSize: 12, color: Colors.text.darkSecondary, lineHeight: 17 },
  showMeta:  { flexDirection: 'row', alignItems: 'center', gap: 4 },
  showMetaText: { fontSize: 11, color: Colors.text.darkTertiary, fontWeight: '500' },
  showPlayBtn: {
    width: 40,
    height: 40,
    borderRadius: 20,
