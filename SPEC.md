...
## 生成フローのサーバー側移行（`feature/resilient-generation`、2026-07-07完了・実機検証済み）
...
**実機検証結果（2026-07-07、vc38）**: ①バックグラウンド移動→復帰で再生成されない ②完了プッシュ通知が届く ③ニュース実測6分 ④ホストAria/Crest音声 — 報告された4件すべて解消をユーザー実機で確認済み。
