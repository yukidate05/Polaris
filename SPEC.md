...
- ⚠️ **2026-07-09: GoogleからADA-CASA AL1（旧Tier 2）評価の正式要求が届いた。期限: 2026-10-06。** 制限付きスコープ（`gmail.readonly`）の検証続行条件で、以後毎年更新が必要。評価には2〜6週間かかるため早期着手推奨（遅くとも2026年9月上旬までに開始）。依頼先はGoogle優待価格のTAC Securityまたは任意のADA認定ラボ。AL2（旧Tier 3、インフラ含む包括評価・Marketplaceバッジ用）は不要でAL1で足りる。メール文面上、認定ラボへの依頼が前提のため無料セルフスキャン案は使えない見込み。次のアクション: TAC SecurityでAL1の現行料金を確認→申し込み→ASVSベース質問票+スキャン提出
